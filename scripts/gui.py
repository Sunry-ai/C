...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.newmap = self.m_toolBar20.AddLabelTool( wx.ID_ANY, u"new", wx.Bitmap( u"fileicon.bmp", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"create a new map", wx.EmptyString, None ) 
		
		self.m_toolBar20.AddSeparator()
		
		self.open = self.m_toolBar20.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"open.bmp", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"open....", wx.EmptyString, None ) 
		
		self.m_toolBar20.AddSeparator()
		
		self.save = self.m_toolBar20.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"save.bmp", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, u"save as...", wx.EmptyString, None ) 
		
		self.m_toolBar20.AddSeparator()
		
		self.temporary = self.m_toolBar20.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"e.bmp", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
		
		self.m_toolBar20.AddSeparator()
		
		self.elements = self.m_toolBar20.AddLabelTool( wx.ID_ANY, u"tool", wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
